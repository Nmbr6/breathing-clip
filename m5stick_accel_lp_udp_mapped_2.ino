 ...
 *  Output data rate is ~500Hz in empirical testing, but will vary based on network speed/bandwidth.
 ...
 *  NOTE: Follow all setup instructions in Readme.md first
 */
